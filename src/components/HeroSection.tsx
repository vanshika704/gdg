...
const HeroSection = () => {
  ...
  return (
    <main className="relative min-h-screen w-full">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] to-[#5e5d5d]"></div>
...
></div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          {/* Right Column - Image Carousel */}
          <div className="relative mt-6 sm:mt-8 lg:mt-0">
            <div className="bg-neutral-800  bg-opacity-30 p-3 sm:p-4 lg:p-6 rounded-2xl sm:rounded-3xl max-w-[400px] sm:max-w-[500px] lg:max-w-[600px] mx-auto"style={{
    boxShadow: "0 4px 6px rgba(255, 255, 255,0.2)", // Thin white shadow
  }}>
              <div className="aspect-video relative overflow-hidden rounded-xl sm:rounded-2xl">
                {carouselImages.map((image, index) => (
                  <div
